    ...
    override fun onCreateView(
       ...
       /* view.findViewById<ImageView>(R.id.rewards_forward).setOnClickListener {
        ...
        view.findViewById<ImageView>(R.id.back_button).setOnClickListener {
            navigateToFragment(MainScreenFragment())
        }
        view.findViewById<TextView>(R.id.help_text).setOnClickListener {
            navigateToFragment(HelpFragment())
        }
        view.findViewById<ImageView>(R.id.business_profile_forward).setOnClickListener {
            navigateToFragment(BuisnessFragment())
        }
        view.findViewById<ImageView>(R.id.rewards_forward).setOnClickListener {
