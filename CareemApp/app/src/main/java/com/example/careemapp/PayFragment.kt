...
class PayFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val payButton = view.findViewById<ImageView>(R.id.payback)

        // Set a click listener to navigate to AllSettingsFragment
        payButton.setOnClickListener {
            // Navigate to AllSettingsFragment using the navigation action
            findNavController().navigate(R.id.action_fragmentpay_to_fragmentMainScreen)
        }

        val bButton = view.findViewById<Button>(R.id.addFundsButton)
